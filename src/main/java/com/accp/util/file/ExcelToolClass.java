...
public class ExcelToolClass {
	   ...
	   private HSSFWorkbook wb = null;//得到Excel工作簿对象  
	    ...
	    public void createColumHeader(List<Map<String,Object>> listInfo) {
	        ...
	        HSSFCell cell3 = null;
	        	...
	        	for (int i = 0; i < listInfo.size(); i++) {
		            ...
		            System.out.println("-----------"+listInfo.get(i).get("用户编号").toString());
		            cell3.setCellValue(new HSSFRichTextString(listInfo.get(i).get("用户编号").toString()));
		            
		            cell3 = row2.createCell(1);
		            cell3.setCellStyle(cellStyle);
		            cell3.setCellValue(new HSSFRichTextString( listInfo.get(i).get("用户昵称").toString()));
		             
		            cell3 = row2.createCell(2);
		            cell3.setCellStyle(cellStyle);
		            cell3.setCellValue(new HSSFRichTextString(listInfo.get(i).get("会员组").toString()));
		             
		            cell3 = row2.createCell(3);
		            cell3.setCellStyle(cellStyle);
		            cell3.setCellValue(new HSSFRichTextString(listInfo.get(i).get("邮箱").toString()+""));
		            
		            cell3 = row2.createCell(4);
		            cell3.setCellStyle(cellStyle);
		            cell3.setCellValue(new HSSFRichTextString( listInfo.get(i).get("积分").toString()));
		            
		            cell3 = row2.createCell(5);
		            cell3.setCellStyle(cellStyle);
		            cell3.setCellValue(new HSSFRichTextString( listInfo.get(i).get("电话").toString()+""));
	     ...
	     *            标题字符串数组
	     */
	    public void createColumHeader2(List<Map<String,Object>> listInfo,int type) {
	    	// 定义单元格格式，添加单元格表样式，并添加到工作簿
	    	HSSFCellStyle cellStyle = wb.createCellStyle();
	    	cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER); // 指定单元格居中对齐
	    	cellStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);// 指定单元格垂直居中对齐
	    	...
	    	if(type==1) {
	    		for (int i = 0; i < listInfo.size(); i++) {
	    			...
	    			cell3.setCellValue(new HSSFRichTextString(listInfo.get(i).get("编号").toString()));
	    			
	    			cell3 = row2.createCell(1);
	    			cell3.setCellStyle(cellStyle);
	    			cell3.setCellValue(new HSSFRichTextString((String) listInfo.get(i).get("报销金额")));
	    			
	    			cell3 = row2.createCell(2);
	    			cell3.setCellStyle(cellStyle);
	    			cell3.setCellValue(new HSSFRichTextString(listInfo.get(i).get("年份").toString()));
	    			
	    			cell3 = row2.createCell(3);
	    			cell3.setCellStyle(cellStyle);
	    			cell3.setCellValue(new HSSFRichTextString((String) listInfo.get(i).get("月份")));
	    			
	    			cell3 = row2.createCell(4);
	    			cell3.setCellStyle(cellStyle);
	    			cell3.setCellValue(new HSSFRichTextString((String) listInfo.get(i).get("部门")));
	    		...
	    		for (int i = 0; i < listInfo.size(); i++) {
	    			...
	    			cell3 = row2.createCell(1);
	    			cell3.setCellStyle(cellStyle);
	    			cell3.setCellValue(new HSSFRichTextString((String) listInfo.get(i).get("报销人")));
